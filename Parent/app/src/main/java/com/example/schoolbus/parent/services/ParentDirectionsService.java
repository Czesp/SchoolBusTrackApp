...
public class ParentDirectionsService {
    private static final String TAG = "ParentDirectionsService";
    private static final String API_KEY = "AIzaSyDGBzaHtkkJjTIEirI92R_xBLVv3yKkD6A";
    private GeoApiContext geoApiContext;
    private static ParentDirectionsService instance;

    private ParentDirectionsService(Context context) {
    ...
    public static synchronized ParentDirectionsService getInstance(Context context) {
        if (instance == null) {
            instance = new ParentDirectionsService(context);
        }
        return instance;
    }
