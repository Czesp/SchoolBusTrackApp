...
public class Bus {
    ...
    // FIX: REMOVE THE DUPLICATE SETTER - Keep only this one
    public void setEtaToNextStop(long etaToNextStop) {
        this.etaToNextStop = etaToNextStop;
    }

    public String getCurrentStatus() { return currentStatus; }
    public void setCurrentStatus(String currentStatus) { this.currentStatus = currentStatus; }

    // FIX: Add this method to handle Object conversion in the ACTIVITY, not in the model
