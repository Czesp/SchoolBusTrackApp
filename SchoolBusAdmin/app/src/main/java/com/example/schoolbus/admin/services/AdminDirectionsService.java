...
public class AdminDirectionsService {
    private static final String TAG = "AdminDirectionsService";
    private static final String API_KEY = "AIzaSyDGBzaHtkkJjTIEirI92R_xBLVv3yKkD6A"; // Use your same API key
    private GeoApiContext geoApiContext;
    private static AdminDirectionsService instance;

    private AdminDirectionsService(Context context) {
    ...
    public static synchronized AdminDirectionsService getInstance(Context context) {
        if (instance == null) {
            instance = new AdminDirectionsService(context);
        }
        return instance;
    }
        ...
        new Thread(() -> {
            try {
                ...
                if (result.routes != null && result.routes.length > 0) {
                    ...
                    long totalDuration = route.legs[0].duration.inSeconds / 60;
